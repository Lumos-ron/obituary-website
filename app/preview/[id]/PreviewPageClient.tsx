    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:py-16">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          All export options (PDF, Word, Image) will include the full visual design with background,
          decorations, and photo. &ldquo;Copy Text&rdquo; copies the text content only.
        </p>
      </div>
    </div>
  );
